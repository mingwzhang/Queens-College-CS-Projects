...
public final class ParserAndTranslator {
    ...
    private static void assignmentOrInvoc() throws SourceFileErrorException {
        ...
        accept(IDENT);                                      //DO NOT COPY OVER 482
        if (getCurrentToken() != LPAREN) {                  //DO NOT COPY OVER 483
            ...
            while (getCurrentToken() == LBRACKET) {         //DO NOT COPY OVER 500
                new LOADFROMADDRinstr();
                nextToken();                                //DO NOT COPY OVER 502
                expr3();                                    //DO NOT COPY OVER 503
                accept(RBRACKET);                           //DO NOT COPY OVER 504
                new ADDTOPTRinstr();
                dim++;
        ...
        else {                                                  //DO NOT COPY OVER  515  

            MethodRec t = lookUpCalledMethod(identName, MethodRec.NOT_KNOWN);

            argumentList(t);                                    //DO NOT COPY OVER  519
            ...
            accept(SEMICOLON);                              //DO NOT COPY OVER  537
        }                                                   //DO NOT COPY OVER  538
